...
<div class="flex min-h-screen items-center justify-center bg-green-100">
  <div class="w-full max-w-md p-8 space-y-3 rounded-xl bg-green-700 shadow-lg">
    ...
    <form class="space-y-6" action="signup.php" method="POST"> <!-- Update action to point to signup.php and use POST method -->
      ...
      <div>
        <button type="submit" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 w-full bg-white text-green-600" fdprocessedid="r7gs1e">SignUp</button> <!-- Change button type to submit -->
      </div>
    </form>
    <p class="text-center text-sm text-white">Already Have an Account? <a class="text-green-200 underline" href="sign-in.php">Sign in</a></p>
  </div>
</div>
